      ...
      tbody.innerHTML = pageItems.map((r, i) => {
        ...
        return `
          <tr>
            ...
            <td class="px-3 py-2 text-sm text-gray-900 font-medium">${escapeHtml(bname)}<div class="text-xs text-gray-500">ID: ${r.batch_id}</div></td>
        ...
        <div class="relative mx-auto mt-12 w-[min(1100px,92vw)]">
          <div class="bg-white rounded-lg shadow">
            <div class="flex items-center justify-between border-b px-4 py-3">
              <div>
                <div class="text-sm text-gray-500">Batch #${batch.batch_id}</div>
